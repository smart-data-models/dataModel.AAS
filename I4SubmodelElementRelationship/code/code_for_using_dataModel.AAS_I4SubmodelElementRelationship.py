...
dataModel = "I4SubmodelElementRelationship"
subject = "dataModel.AAS"
descriptions = [{'language': 'en', 'text': 'Submodel Relationship [contains various data related to the Relationship of an intelligent agent capability to its operations]'}]
