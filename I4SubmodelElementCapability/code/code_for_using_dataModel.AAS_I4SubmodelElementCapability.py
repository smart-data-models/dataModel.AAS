...
dataModel = "I4SubmodelElementCapability"
subject = "dataModel.AAS"
descriptions = [{'language': 'en', 'text': 'Submodel capability [contains various data related to the capability of an intelligent agent]'}]
